...
$filename = '../pages/burgercounter.txt'; // counter file
      ...
      <div class="">
        <nav class="navbar">
          ...
          <div class="holdingcontainer">
               ...
               <div class="internalcontainerburger"><img src="../img/burger.jpg" alt="burger" width="100%"></a><h4>Handmade Buns with sesame, Beef patty, Cheddar Cheese, Fresh slices of tomatoes and Lettuce</h4><h2>303 Calories</h2><h2>Vegetarian</h2>
               <h2> Total votes = <?php echo $counter; ?></h2> 
              
   

    <div class="textquestion"><h2>Are you a Burger lover for sure ? </h2> 
    <input type=button id="tryagainbutton" onClick="location.href='../pages/quizburger.html'" value='Test me !'>
